...
class MQ():
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.CNGCurve = [2.3,0.25,-0.42]    # two points are taken from the curve. 
    ...
    def MQPercentage(self):
        ...
        val["GAS_CNG"]  = self.MQGetGasPercentage(read/self.Ro, self.GAS_CNG)
        return val
    ...
    def MQGetGasPercentage(self, rs_ro_ratio, gas_id):
        if ( gas_id == self.GAS_CNG ):
            return self.MQGetPercentage(rs_ro_ratio, self.CNGCurve)
        return 0
